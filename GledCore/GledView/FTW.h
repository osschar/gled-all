...
extern Fl_Color	postnamebox_color;
extern Fl_Color	postnamebox_edit_color;
extern Fl_Color	postnamebox_textcolor;
extern Fl_Color	postnamebox_edit_textcolor;
...
extern Fl_Boxtype postnamebox_box;
...
class ListDesignator : public Fl_Input
{
protected:
  bool m_editable;
  bool m_edit_active;
...
public:
  ListDesignator(bool editp);

  bool edit_active() const { return m_edit_active; }
  void edit_active(bool ea);
...
public:
  ...
  void fix_MIR_beta(auto_ptr<ZMIR>& mir);
