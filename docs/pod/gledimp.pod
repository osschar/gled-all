...
I<For methods only:> If the first character on the comment line is
'C<!>' the method will be tagged as I<local>: MIR will be sent to the
local saturn only. This is useful for updating or printing of local
data members.
