...
public:
   ...
   *	\param		worldl			[in] lss world matrix, or 0
...
protected:
  ...
  // Init methods
  bool		InitQuery(LSSCache& cache, const LSS& lss, const Matrix4x4* worldl=0, const Matrix4x4* worldm=0);
};
...
public:
  ...
  bool Collide(LSSCache& cache, const LSS& lss, const HybridModel& model, const Matrix4x4* worldl=0, const Matrix4x4* worldm=0);
