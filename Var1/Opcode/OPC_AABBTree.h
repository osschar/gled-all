...
public:
  // Data access
  const udword*	GetPrimitives()   const	{ return mNodePrimitives; }
  udword	GetNbPrimitives() const	{ return mNbPrimitives; }
...
public:
  ...
  // Data access
  const udword*	GetIndices() const { return mIndices; }      //!< Catch the indices
  udword	GetNbNodes() const { return mTotalNbNodes; } //!< Catch the number of nodes
