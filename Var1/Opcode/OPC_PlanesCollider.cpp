...
/* If the box is completely included, so are its children. We don't
   need to do extra tests, we can immediately output a list of visible
   children. Those ones won't need to be clipped. */
