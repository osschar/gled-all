 Hack-up for linux (september 2006)
 -----------------

    Done for inclusion into the Gled project (http://www.gled.org/) by matevz.tadel@cern.ch
    Code left as close to original 1.3 as possible.
