...
int tableRetrieve(int a, TableRoot *table, void **ref)
{
...
int tableInsert(int a, TableRoot *table, void *ref)
{
    int i1 = a / (LEVEL2COUNT * LEVEL3COUNT);
    int i2 = (a / LEVEL3COUNT) % LEVEL2COUNT;
    int i3 = a % LEVEL3COUNT;
...
int tableRemove(int a, TableRoot *table, void **wasref)
{
    int i1 = a / (LEVEL2COUNT * LEVEL3COUNT);
    int i2 = (a / LEVEL3COUNT) % LEVEL2COUNT;
    int i3 = a % LEVEL3COUNT;
...
int tableIterate(TableRoot *table, TableIterator *ti, int *i, void **ref)
{
    int done;
...
static void dumpTriangles(ACTCEdge *e, FILE *fp)
{
	...
	if(c + 1 + sprintf(v, "%p", e->Triangles[i].FinalVert) > 78) {
	    fputs("\n", fp);
	    c = fprintf(fp, "        ");
	}
	c += fprintf(fp, " %s", v);
...
static void *reallocAndAppend(void **ptr, int *itemCount, size_t itemBytes,
    void *append)
{
    void *t;
 ...
 */
static int incVertexValence(ACTCData *tc, int v, ACTCVertex **found)
{
    ACTCVertex *vertex;
...
int actcParamu(ACTCData *tc, int param, int value)
{
    /*
...
int actcGetParamu(ACTCData *tc, int param, int *value)
{
...
int actcAddTriangle(ACTCData *tc, int v1, int v2, int v3)
{
...
int actcStartNextPrim(ACTCData *tc, int *v1Return, int *v2Return)
{
    ACTCVertex *v1 = NULL;
    ACTCVertex *v2 = NULL;
    int findResult;
...
int actcGetNextVert(ACTCData *tc, int *vertReturn)
{
    ACTCEdge *edge;
    int wasEdgeFound = 0;
...
int actcTrianglesToPrimitives(ACTCData *tc, int triangleCount,
    int (*triangles)[3], int primTypes[], int primLengths[], int vertices[],
    int maxBatchSize)
{
    int r;
    int curTriangle;
