...
void MTW_MetaView::build_subview(MTW_SubView* sv, MetaSubViewInfo* msvi,
				 Int_t cX, Int_t cY)
{
  static const Exc_t _eh("MTW_MetaView::build_subview ");
  ...
  msvi->CopyListByGlass<MetaWeedInfo>(weeds);
...
{
  static const Exc_t _eh("MTW_MetaView::BuildByLensGraph ");
  ...
  mvi->CopyListByGlass<MetaSubViewInfo>(subviews);
...
{
  static const Exc_t _eh("MTW_MetaView::Rebuild ");
