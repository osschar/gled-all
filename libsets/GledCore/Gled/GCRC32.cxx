...
const UInt_t GCRC32::sInit   = 0xffffffff;
const UInt_t GCRC32::sXorOut = 0xffffffff;

//==============================================================================

void GCRC32::process(const UChar_t* p, Int_t len)
{
  while (len-- > 0)
  {
    mCrc = CrcTable[(mCrc ^ *p++) & 0xff] ^ (mCrc >> 8);
  }
}

//==============================================================================

UInt_t GCRC32::CRC32(const UChar_t* p, Int_t len)
{
   UInt_t crc = sInit;
   while (len-- > 0)
   {
