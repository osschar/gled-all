...
void TubeTvor_GL_Rnr::TriangleFan(TubeTvor::vRingInfo_i r1, TubeTvor::vRingInfo_i r2)
{
...
void TubeTvor_GL_Rnr::QuadStrip(TubeTvor::vRingInfo_i r1, TubeTvor::vRingInfo_i r2)
{
...
void TubeTvor_GL_Rnr::Render(TubeTvor* ttvor)
{
  ...
  TubeTvor::vRingInfo_i i = ttvor->mRings.begin();
  TubeTvor::vRingInfo_i j = i + 1;
